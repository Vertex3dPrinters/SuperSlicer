...
if (APPLE)
# because it needs  -L/usr/local/opt/zstd/lib or export LDFLAGS="-L$(brew --prefix zstd)/lib" (+ /libzstd.dylib ?)
prusaslicer_add_cmake_project(OpenVDB
    ...
    CMAKE_ARGS
        ...
        -DCMAKE_STATIC_LINKER_FLAGS="/usr/local/opt/zstd/lib/libzstd.dylib"
)
else()
prusaslicer_add_cmake_project(OpenVDB
    URL https://github.com/tamasmeszaros/openvdb/archive/refs/tags/v6.2.1-prusa3d.zip #v6.2.1 patched
